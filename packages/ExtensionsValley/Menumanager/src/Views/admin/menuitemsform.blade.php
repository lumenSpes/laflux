...
@section('content-area')
    ...
    <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('menu_name') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::text('menu_name', isset($menuitems->menu_name) ? $menuitems->menu_name : request()->old('menu_name'), [
                                    'class' => 'form-control',
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('source') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::text('source', isset($menuitems->source) ? $menuitems->source : request()->old('source'), [
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('menu_type') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select(
                                    'menu_type',
                                    ExtensionsValley\Menumanager\Models\Menutypes::getMenuTypes(),
                                    isset($menuitems->menu_type) ? $menuitems->menu_type : null,
                                    [
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('position') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select(
                                    'parent_menu',
                                    ['0' => 'Root Level Menu'] +
                                        ExtensionsValley\Menumanager\Models\Menuitems::getParentMenus($current_menu_id)->toArray(),
                                    isset($menuitems->parent_menu) ? $menuitems->parent_menu : null,
                                    [
                                        'class' => 'form-control select2',
                                        'required' => 'required',
                                    ],
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('is_new_tab') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select(
                                    'is_new_tab',
                                    ['0' => 'No', '1' => 'Yes'],
                                    isset($menuitems->is_new_tab) ? $menuitems->is_new_tab : null,
                                    [
                                        'class' => 'form-control select2',
                                        'required' => 'required',
                                    ],
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('is_spa') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select('is_spa', ['0' => 'No', '1' => 'Yes'], isset($menuitems->is_spa) ? $menuitems->is_spa : null, [
                                    'class' => 'form-control select2',
                                    'required' => 'required',
                                ]) !!}
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('ordering') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::number('ordering', isset($menuitems->ordering) ? $menuitems->ordering : request()->old('ordering'), [
                                    'class' => 'form-control',
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select(
                                    ...
                                    isset($menuitems->status) ? $menuitems->status : null,
                                    [
                                        'class' => 'form-control select2',
                                        'required' => 'required',
                                    ],
                    ...
                    <div class="x_content">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group {{ $errors->has('layout') ? 'has-error' : '' }} control-required">
                                ...
                                {!! Form::select(
                                    'pages',
                                    ['0' => 'select any page'] + ExtensionsValley\Pages\Models\Pages::getPageswithSlug()->toArray(),
                                    null,
                                    [
        ...
        <input type="hidden" name="accesstoken"
            value="{{ request()->has('accesstoken') ? request()->get('accesstoken') : '' }}" />
