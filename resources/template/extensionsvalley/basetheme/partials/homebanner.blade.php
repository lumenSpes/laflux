...
?>
 <div class="fh5co-slider">
        <div class="owl-carousel owl-carousel-fullwidth">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="fh5co-owl-text-wrap">
                                <div class="fh5co-owl-text text-center to-animate">
                                    ...
                                    <h2 class="fh5co-sub-lead">{!! $banner->description!!}
                                    <a href="{{$banner->link}}">Click Here</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="item" style="background-image:url({{asset("$themeHelper->active_template_path/images/slide_1.jpg")}})">
                <div class="fh5co-overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="item" style="background-image:url({{asset("$themeHelper->active_template_path/images/slide_2.jpg")}})">
                <div class="fh5co-overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="item" style="background-image:url({{asset("$themeHelper->active_template_path/images/slide_3.jpg")}})">
                <div class="fh5co-overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="item" style="background-image:url({{asset("$themeHelper->active_template_path/images/slide_4.jpg")}})">
                <div class="fh5co-overlay"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
